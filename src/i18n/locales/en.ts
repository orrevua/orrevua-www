...
export const translations: Translations = {
  ...
  blog: {
    sectionLabel: "blog",
    indexTitle: "Tech tips & articles",
    indexSubtitle: "Notes from the codebase — patterns I lean on, trade-offs I make, and things I wish I had known earlier.",
    ...
    notAvailableInLocale: "This post is not available in your language yet.",
  },
  hero: {
  ...
  projects: {
    ...
    showStudyProjects: "Show study projects",
    hideStudyProjects: "Hide study projects",
  },
  skills: {
    sectionLabel: "skills",
    categories: {
